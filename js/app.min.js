...
const functions_getHash = () => location.hash ? location.hash.replace('#', '') : null
...
function closeMenuWithSwipe() {
	if (window.innerWidth < 768 && isMobile.any()) {
		...
		function handleTouchMove(e) {
			...
			if (xDiff < -40) functions_menuClose()
		}
	}
}
...
;// ./src/js/files/forms/inputmask.js
